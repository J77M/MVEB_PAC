% selectivity of PAC memory-related channels
% figures 3.4 (B)- (D)
...
save_path = "/home/jur0/project_iEEG/code/figs/OUT/PAC_selectivity";
...
[num_sel_mars, num_all_mars, labelsMars] = ROI.getSelectivity(areas_mars, areas_mars_all);
% selectivity_mars = 100*num_sel_mars./num_all_mars;
...
yticks(0:20:60)
title("(D) Selectivity of PAC memory-related ROIs")
ylabel('selectivity [%]')
